...
/**
 * 定位路径使用,使用 resolve(dir) 时会自动生成到该 dir 目录的路径。
 */
function resolve(dir) {
  return path.join(__dirname, dir)
}

const name = title || 'Vue Interesting' // page title
console.log(title)
...
module.exports = {
  ...
  chainWebpack(config) {
     ...
     * https://www.cnblogs.com/vivotech/p/13924816.html
     */
    ...
    /**
     * runtime.js 处理策略
     * 使用 script-ext-html-webpack-plugin 插件将其内链在 index.html。
     * 变动路由就只有被改动的路由 js 会改变，对其他路由 js 文件没有影响。
     */
